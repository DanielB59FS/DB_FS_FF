...
public class DummyAIController : MonoBehaviour {
    public enum States { Idle, Death}
    ...
    private int maxHp, minHp, mana, stamina, aggroRange, teamwork, bravery, intelligence, allyCount, allyBonus; //Attributes for AI logic, will be added functionality as AI gets smarter
    public int hp;
